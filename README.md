...
**UX Elements Mapping (Jesse James Garrett):**

| UX Plane | Deliverable |
|---|---|
| **Strategy** | Problem statement, Value Proposition Canvas, UX Personas |
| **Scope** | Benchmark analysis, feature map, functional requirements |
| **Structure** | Navigation flow diagram |
| **Skeleton** | Low-Fi mockups |
| **Surface** | High-definition interfaces |

---

## 🔍 Benchmark Analysis

Competitive analysis following the two-phase methodology (Exploratory + Competitive Reference).

### Tool Selection

| # | Tool | Category | Justification |
|---|---|---|---|
| 1 | **Lomi** | Direct Competitor | Chilean marketplace connecting local producers with buyers directly. Same problem, same cultural context. |
| 2 | **GoodMeal** | Analogous Competitor | Chilean food rescue app with 1M+ users. Deals with fresh food surplus but uses mystery bags — different UX logic. |
| 3 | **Cheaf** | Analogous Competitor | Chilean surplus food app reaching 1.5M users. Works with fruits, vegetables, and dairy via pick-up model. |
| 4 | **Uber Eats** | Design Reference | Sets the UX standard for food delivery catalog, ordering flow, and order tracking at scale. |
...
Three personas identified based on research data and field context:

| Persona | Profile | Key Need |
|---|---|---|
| **Juan Catrileo** | Horticultural producer, 52, Cunco | Publish weekly stock and receive pre-orders before Saturday |
| **Marcela Vidal** | UFRO administrative staff, 41, Temuco | Pre-order fresh produce without going to the fair |
| **Diego Painevil** | Engineering student, 21, UFRO | Know what's available and compare prices before leaving campus |
...
| Resource | Link |
|---|---|
| Figma Prototype | [Open in Figma](https://www.figma.com/design/aAvGQ0lL6xu3XAz2v8vcvm/Fructus-Iter?node-id=329-3128&p=f&t=W8TL7ZePVDXgkSBs-0) |
